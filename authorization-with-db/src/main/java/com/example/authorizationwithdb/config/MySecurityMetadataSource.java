...
import com.example.authorizationwithdb.mapper.ResourceMapper;
...
/**
 * 自定义的元数据源类，用来提供鉴定权限过程中，访问资源所需的角色（权限），此应为DAO层
 */
@Component
public class MySecurityMetadataSource implements FilterInvocationSecurityMetadataSource {
    ...
    public Collection<ConfigAttribute> getAttributes(Object object) throws IllegalArgumentException {
        ...
        //从数据库中得到所有资源，以及对应的角色
        List<MyResourceBean> resources = resourceMapper.selectAllResources();
        for (MyResourceBean resource : resources){
            //地址匹配
